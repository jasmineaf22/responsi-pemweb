...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="left">
        <img src="../images/horrorflix.png" alt="icon" />
      </div>
      <div class="right">
        <div class="sign-up">
          <form action="../function/regisProcess.php" method="post">
            ...
            <div class="password">
              <input type="password" id="password" name="password" placeholder="Password" oninput="validateForm(this)" />
              <p id="validationMessage" class="hidden">Hanya huruf dan angka yang diizinkan.</p>
            ...
            <input class="button" type="submit" name="register" value="Create Account" />
          </form>
          <p>Already have an account? <a class="up" href="login.php">Sign In</a></p>
        </div>
      </div>
      ...
      <div class="center" hidden>
        <div id="popup">
          ...
          <a href="login.php"><p>Sign In Now</p></a>
        </div>
      </div>
    </div>
